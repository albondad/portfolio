      ...
      <Box className="ImageGallery-main">
        {!!imageSourcesProp[0] && (
          <Box className="ImageGallery-image">
            <Image src={imageSourcesProp[currentIndexState]} layout="fill" />
          </Box>
        )}
      </Box>
      <Box className="ImageGallery-items">
        {imageSourcesProp.map((element, index) => {
          ...
          const itemClassName = classNames("ImageGallery-item", {
            "ImageGallery-isDisabledTrue": currentIndexState === index,
            "ImageGallery-isDisabledFalse": currentIndexState !== index,
          });
