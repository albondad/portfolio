...
export const workExperience: WorkExperienceType[] = [
    {
        ...
        organization: 'Bodhi',
        responsibilities: [
            'Led development of front-ends for web applications and websites',
            'Developed web application to manage smart devices for hotel rooms',
            'Set up web application to assist with Bahamas travel in the future',
            'Maintain and debugged existing company web applications',
            'Integrated front-ends with new and existing REST APIs',
            'Worked with full stack developers in designing and developing features',
            'Researched and discussed solutions to assist with improving frontend development',
            'Provided mockups and design elements for use in web and physical products',
        ],
        skills: [
            'React',
            'Node.js',
